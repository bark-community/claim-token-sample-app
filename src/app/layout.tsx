        ...
        <footer className="text-center py-4 text-xs text-gray-500">
          <div className="flex flex-col items-center space-y-2">
            <div className="flex space-x-4">
              {/* GitHub */}
              <a href="https://github.com/bark-community/asset-management-dapp" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700"><FaGithub /></a>
              {/* Discord */}
              <a href="https://discord.com/QY9NvRYz" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700"><FaDiscord /></a>
              {/* Twitter */}
